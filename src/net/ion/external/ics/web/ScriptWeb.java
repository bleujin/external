...
public class ScriptWeb implements Webapp {
	...
	@POST
	@Produces(ExtMediaType.TEXT_PLAIN_UTF8)
	public String editScheduleInfo(@PathParam(Def.Script.Sid) final String sid, @DefaultValue("0-59") @FormParam(Def.Schedule.MINUTE) final String minute, @DefaultValue("0-23") @FormParam(Def.Schedule.HOUR) final String hour, @DefaultValue("1-31") @FormParam(Def.Schedule.DAY) final String day,
