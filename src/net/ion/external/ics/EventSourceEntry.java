...
public class EventSourceEntry implements Closeable{
	...
	public Writer newWriter(ICSSubCraken craken, String lid, String eventId) throws IOException {
...
class EventSourceWriter extends Writer{
	...
	public EventSourceWriter(EventSourceEntry ese, ICSSubCraken craken, String lid, String eventId) throws IOException {
		this.ese = ese ;
		this.lid = lid ;
