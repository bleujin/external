...
import net.ion.craken.db.QueryParam;
...
public class ScriptUserProcedure extends UserProcedure implements QueryParam {


	private IDBController dc ;
	private AbScriptManager manager;
	public ScriptUserProcedure(IDBController dc, AbScriptManager manager, String psql) {
		super(dc, psql);
		this.dc = dc ;
