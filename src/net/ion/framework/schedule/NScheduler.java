...
public class NScheduler extends Thread {
	private String name = null;

	private Hashtable<String, Job> jobs = new Hashtable<String, Job>();
	private Logger logger = Logger.getLogger(NScheduler.class);
	private ExecutorService workers ; 
	
	public NScheduler(String name, ExecutorService workers) {
		super(name);
		this.name = name;
	...
	public void run() {
		logger.info("NScheduler started. :" + this.toString());
		...
		logger.info("NScheduler stopped. :" + this.toString());
	}
